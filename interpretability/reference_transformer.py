...
class TransformerBlock(nn.Module):
    ...
    def attn(self, x, padding_mask):
        x = self.norm1(x)
        additive_mask = t.where(padding_mask, -10000, 0)[:, None, None, :]  # [batch, head=1, qpos=1, kpos]
        # print(additive_mask)
...
class SimpleTokenizer:
    ...
    def tokenize(self, strs: List[str], max_len: Optional[int] = None) -> t.Tensor:
